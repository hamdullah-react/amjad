  ...
  const getContactCards = () => {
    ...
    if (contactInfo.phone) {
      cards.push({
        ...
        description: contactInfo.workingHours?.monday || "",
    ...
    if (contactInfo.workingHours) {
      ...
      cards.push({
        icon: Clock,
        title: "Working Hours",
        details: firstDay && lastDay ? `${firstDay} - ${lastDay}` : "",
        description: contactInfo.workingHours.monday || "",
        color: "orange"
      })
    }
              ...
              {showError && (
                <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg flex items-start animate-fade-in">
                  ...
                  <div>
                    ...
                    {contactInfo?.phone && (
                      <span className="text-red-600 text-sm">You can also call us at {contactInfo.phone}</span>
                    )}
                  </div>
                </div>
              )}
